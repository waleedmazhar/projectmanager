	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="breadcrumb clearfix">
			...
			<div class="container">
				...
				<ul class="pull-left">
					<li><a href="index-2.html"><i class="icon-home"></i> Home</a> <span class="divider">/</span></li>
					<li><a href="#"><i class="icon-th"></i> General</a> <span class="divider">/</span></li>
					<li class="active"><a href="#"><i class="icon-circle"></i> Buttons</a></li>
				</ul>
				<!-- / Top Fixed Bar: Breadcrumb Location -->
		...
		<div class="navbar navbar-inverse" id="nav">
			...
			<div class="navbar-inner">
				...
				<ul class="nav">
					...
					<li><a href="index-2.html"><i class="icon-align-justify"></i> Dashboard</a></li>
					<!-- / Main Navigation: Dashboard -->
					...
					<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="buttons.html"><i class="icon-circle-blank"></i> Buttons</a></li>
							</ul>
					</li>
					<!-- / Main Navigation: General -->
